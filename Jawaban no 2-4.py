...
querry = '''SELECT country.Name as Negara_Asean, country.Population as Populasi_Negara, GNP, city.Name 
          as Ibukota, city.Population, country.SurfaceArea  FROM world.country
          join world.city 
          on country.Capital = 
          city.ID
...
fig1, ax1 = plt.subplots(num='Soal no 4')
ax1.pie(y, labels=labels, autopct='%1.1f%%',
        shadow=False, startangle=0)
plt.title('Persentase Luas Daratan Asean', pad=30, fontsize=15)
